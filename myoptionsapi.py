...
class myClient2(EWrapper, iclient):
    ...
    def tickGeneric(self, reqId:TickerId, tickType:TickType, value:float):
        ...
        # if tickType == 24:
        #     if right == 'P':
        #         self.quotedatadict[symbol][month].quote.at[srown, 'IV P'] = value
        #     elif right == 'C':
        #         self.quotedatadict[symbol][month].quote.at[srown, 'IV C'] = value
...
if __name__ == '__main__':
    ...
    for i in range(10, 16):
        conP = make_contract('VXX', secType='OPT', exchange='SMART', right='P', strike=i)
        conC = make_contract('VXX', secType='OPT', exchange='SMART', right='C', strike=i)
        for m in monthlist:
    ...
    filepath = r'E:\ibdata2'
    if not os.path.exists(filepath):
        os.makedirs(filepath)
    myapp = myClient2(conlist, filepath)
